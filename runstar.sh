...
#cd $2/${outfolder1}/${outfolder2}/${outfolder3}

module load STAR/2.5.3a-foss-2016b

STAR --outFilterMismatchNmax 4 --genomeDir ${1}/genome --readFilesCommand zcat  --genomeLoad NoSharedMemory --readFilesIn ${datafolder}/${datafile1} ${datafolder}/${datafile2} --runThreadN 5 --quantMode GeneCounts --outFileNamePrefix $2/star_out --outTmpDir $2/star_out_temp
