...
STAR --outFilterMismatchNmax 4 --genomeDir $2/genome --readFilesCommand zcat  --genomeLoad NoSharedMemory --readFilesIn ${datafolder}/${datafile1} ${datafolder}/${datafile2} --runThreadN 5 --quantMode GeneCounts
